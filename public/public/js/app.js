$(document).ready(function(){
    $('form#filter').change(function(){
        ...
        $.ajax({
            ...
            //   },
            url: "http://localhost/BACK-END/LARAVEL%20PRO/unimart/product/filterAjax/"+id,
            method: 'get',
            data: data,
            dataType: 'text',
    ...
    $('#filterChild').change(function(){
       ...
       var  price_filter = $('[name="r-priceChild"]:radio:checked').val();
        ...
        $.ajax({
            ...
            url: "http://localhost/BACK-END/LARAVEL%20PRO/unimart/firtChildAjax",
            method: 'get',
            data: data,
            dataType: 'text',
            success: function (data) {
...
// })
 function addCat(id){
    ...
    var value = $(".color ul li.active input.d-none").val();
      ...
      $.ajax({
        url: "http://localhost/BACK-END/LARAVEL%20PRO/unimart/cat/add/"+id,
        method: 'get',
        data: data,
        dataType: 'text',
        success: function (data) {
            window.location.href = "http://localhost/BACK-END/LARAVEL%20PRO/unimart/gio-hang";
        }
    })
}
$(document).ready(function(){
